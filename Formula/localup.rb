class Localup < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/localup-dev/localup/releases/download/v0.0.1-beta6/localup-macos-arm64.tar.gz"
      sha256 "226a3e524b8b8379118afc4bff31a37467713599225255165c29b3e5b7fd4e81"
    else
      url "https://github.com/localup-dev/localup/releases/download/v0.0.1-beta6/localup-macos-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/localup-dev/localup/releases/download/v0.0.1-beta6/localup-linux-arm64.tar.gz"
      sha256 "15e54c32a6a394a5f4ceec982287c7d18bab9d00a7faae499ed64ad87c283fbc"
    elsif Hardware::CPU.intel?
      url "https://github.com/localup-dev/localup/releases/download/v0.0.1-beta6/localup-linux-amd64.tar.gz"
